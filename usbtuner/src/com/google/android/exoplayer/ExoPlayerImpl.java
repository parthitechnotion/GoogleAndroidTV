...
/* package */ final class ExoPlayerImpl implements ExoPlayer {
  ...
  public ExoPlayerImpl(int rendererCount, int minBufferMs, int minRebufferMs) {
    ...
    eventHandler = new ExoPlayerHandler(this);
  ...
  private static class ExoPlayerHandler extends WeakHandler<ExoPlayerImpl> {
    public ExoPlayerHandler(ExoPlayerImpl ref) {
      super(ref);
    }

    @Override
    public void handleMessage(Message msg, ExoPlayerImpl exoPlayer) {
      exoPlayer.handleEvent(msg);
    }
  }
}
